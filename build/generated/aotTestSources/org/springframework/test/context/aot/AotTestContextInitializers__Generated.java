...
import com.abinator.urlshortener.UrlshortenerApplicationTests__TestContext001_ApplicationContextInitializer;
...
public class AotTestContextInitializers__Generated {
  public static Map<String, Supplier<ApplicationContextInitializer<? extends ConfigurableApplicationContext>>> getContextInitializers(
    ...
    map.put("com.abinator.urlshortener.UrlshortenerApplicationTests", () -> new UrlshortenerApplicationTests__TestContext001_ApplicationContextInitializer());
    return map;
  }
  ...
  public static Map<String, Class<? extends ApplicationContextInitializer<?>>> getContextInitializerClasses(
    ...
    map.put("com.abinator.urlshortener.UrlshortenerApplicationTests", UrlshortenerApplicationTests__TestContext001_ApplicationContextInitializer.class);
    return map;
  }
}
